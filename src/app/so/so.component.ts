...
export class SoComponent implements OnInit {
  ...
  formControlNames = {
    ...
    directorFullnameNP: 'directorFullnameNP',
    cPhone: 'cPhone',
    cMobile: 'cMobile',
    active: 'active',
    createdBy: 'createdBy',
  ...
  constructor(
    ...
    this.soForm = this.formBuilder.group({
      ...
      [this.formControlNames.directorFullname]: '',
      [this.formControlNames.directorFullnameNP]: '',
  ...
  edit(data) {
    ...
    this.updateSoForm = this.formBuilder.group({
      ...
      [this.formControlNames.directorFullname]: this.setEdit['directorFullname'],
      [this.formControlNames.directorFullnameNP]: this.setEdit['directorFullnameNP'],
